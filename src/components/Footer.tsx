    ...
    <footer className="bg-gray-900 text-gray-400">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-sm space-y-2">
          ...
          <p>&copy; {new Date().getFullYear()} HireAnyPro. All rights reserved. · <Link href="/privacy" className="hover:text-white transition-colors">Privacy Policy</Link> · <Link href="/terms" className="hover:text-white transition-colors">Terms of Service</Link> · <Link href="/sms-policy" className="hover:text-white transition-colors">SMS Policy</Link></p>
        </div>
      </div>
    </footer>
  );
